...
class TxnMallTest(TestcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 TNC:
        ...
        # First: use raw transaction API to send 1210 TNC to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50TNC for another
        ...
        # Node0's total balance should be starting balance, plus 100TNC for 
