...
###Build Testcoin Core for Linux, Windows, and OS X:
  ...
  4. OS X unsigned installer (testcoin-${VERSION}-osx-unsigned.dmg)
...
- Update testcoin.org version
  ...
  - First, check to see if the Testcoin.org maintainers have prepared a
    release: https://github.com/testcoin/testcoin.org/labels/Releases
  ...
  - If they have not prepared a release, follow the Testcoin.org release
    instructions: https://github.com/testcoin/testcoin.org#release-notes
