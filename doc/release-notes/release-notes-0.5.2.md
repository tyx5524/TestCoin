...
Use the correct base transaction fee of 0.0005 TNC for accepting transactions into mined blocks (since 0.4.0, it was incorrectly accepting 0.0001 TNC which was only meant to be relayed).
