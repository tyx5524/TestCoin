The following is a list of assets used in the testcoin source and their proper attribution.
...
* License: MIT
* Site: [https://testcointalk.org/index.php?topic=15276.0](https://testcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original testcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/testcoin.icns, src/qt/res/src/testcoin.svg,
	src/qt/res/src/testcoin.ico, src/qt/res/src/testcoin.png,
	src/qt/res/src/testcoin_testnet.png, docs/testcoin_logo_doxygen.png,
