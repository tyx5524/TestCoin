...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CTestcoinAddress demoAddress = CTestcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CTestcoinAddress setaccountDemoAddress = CTestcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CTestcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CTestcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
