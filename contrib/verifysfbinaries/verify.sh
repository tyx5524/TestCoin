...
###   This script attempts to download the signature file SHA256SUMS.asc from testcoin.org
...
WORKINGDIR="/tmp/testcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://testcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://testcoin.org/bin/"
VERSIONPREFIX="testcoin-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[testcoin-]<version>-[rc[0-9]] (example: testcoin-0.9.2-rc1)"
   echo "wget output:"
